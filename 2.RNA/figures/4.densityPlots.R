...
colScale <- scale_colour_manual(name = element_blank(), values = c("None" = "#4daf4a", "Up" = "#e41a1c", "Down" = "#377eb8", "Both" = "#984ea3"), aesthetics = c("colour", "fill"))
...
tiff("densityPlots_noHiC/TNFa_all.tiff", width = 20, height = 20, units = "cm", compression = "lzw+p", type = "cairo", res = 1200)
p <- baseplot %+% pD$TNFa[group %in% c("None", "Both", "Down", "Up")] +
  coord_cartesian(xlim = c(-1.5, 3))
print(p)
dev.off()

tiff("densityPlots_noHiC/TNFa_up_down.tiff", width = 20, height = 20, units = "cm", compression = "lzw+p", type = "cairo", res = 1200)
p <- baseplot %+% pD$TNFa[group %in% c("None", "Down", "Up")] +
  coord_cartesian(xlim = c(-1.5, 3)) 
print(p)
dev.off()

tiff("densityPlots_noHiC/TNFa_up.tiff", width = 20, height = 20, units = "cm", compression = "lzw+p", type = "cairo", res = 1200)
p <- baseplot %+% pD$TNFa[group %in% c("None", "Up")] +
  coord_cartesian(xlim = c(-1.5, 3)) 
print(p)
dev.off()

tiff("densityPlots_noHiC/TNFa_down.tiff", width = 20, height = 20, units = "cm", compression = "lzw+p", type = "cairo", res = 1200)
...
tiff("densityPlots_noHiC/Palmitate_all.tiff", width = 20, height = 20, units = "cm", compression = "lzw+p", type = "cairo", res = 1200)
p <- baseplot %+% pD$Palmitate[group %in% c("None", "Both", "Down", "Up")]
print(p)
dev.off()

tiff("densityPlots_noHiC/Palmitate_up_down.tiff", width = 20, height = 20, units = "cm", compression = "lzw+p", type = "cairo", res = 1200)
p <- baseplot %+% pD$Palmitate[group %in% c("None", "Down", "Up")] 
print(p)
dev.off()

tiff("densityPlots_noHiC/Palmitate_up.tiff", width = 20, height = 20, units = "cm", compression = "lzw+p", type = "cairo", res = 1200)
p <- baseplot %+% pD$Palmitate[group %in% c("None", "Up")] 
print(p)
dev.off()

tiff("densityPlots_noHiC/Palmitate_down.tiff", width = 20, height = 20, units = "cm", compression = "lzw+p", type = "cairo", res = 1200)
